...
public class PermissionHelper {
     ...
     */
    public void requestPermission(FragmentActivity activity, String[] permissions, PermissionListener permissionListener) {
     ...
     * @param activity FragmentActivity
     */
    private void getPermissionFragment(FragmentActivity activity, AttachListener attachListener) {
