...
public interface ApiServer {
    ...
    /**
     * 自己的测试的接口信息 直接发送请求 地址
     *
     * @param params
     * @return
     */
    @FormUrlEncoded
    @POST("mechineShelfList.do")
    Observable<BaseModel<Object>> getCeShi2(@FieldMap HashMap<String, String> params);
    ...
    Observable<BaseModel<Object>> getUpload(@PartMap Map<String, RequestBody> map, @Part MultipartBody.Part parts);
     ...
     */
    @POST("api/Activity/get_activities?")
    Observable<Base2Model<List<Bean1>, Bean2, List<Bean3>>> getMain2Demo(
            @Query("time") String requestType);
    ...
    @FormUrlEncoded
    @POST("api/Activity/get_activities?")
    Observable<Base2Model<List<Bean1>, Bean2, List<Bean3>>> getMain3Demo(
    ...
    @FormUrlEncoded
    @POST("getAllPhoto.do")
    Observable<MainBean2> myother(@FieldMap HashMap<String, String> params);
