...
public class NetWorkUtils {
            ...
            if (networkInfo.getType() == ConnectivityManager.TYPE_WIFI) {
                ...
                switch (networkType) {
                    ...
                    case TelephonyManager.NETWORK_TYPE_LTE:  //api<11:replace by 13
                        netType = NET_TYPE_4G;
                        break;
                    case TelephonyManager.NETWORK_TYPE_NR:  //api<29:replace by 13
                        netType = NET_TYPE_5G;
                        break;
                    default:
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
                MvpApplication.getInstance().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            MvpApplication.getInstance().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) MvpApplication.getInstance()
...
//        isAvailableByPing successMsg
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) MvpApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) MvpApplication.getInstance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
     ...
     * <li>{@link NetworkType#NETWORK_5G     } </li>
